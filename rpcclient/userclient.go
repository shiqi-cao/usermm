...
import (
	...
	codeModule "entry_task/usermanagementsys/src/code"
	gpool "entry_task/usermanagementsys/src/gpool"
	pb "entry_task/usermanagementsys/src/proto"
)
...
func getRPCClient() (*clientWrap, error) {
	// get conn with a timeout context
